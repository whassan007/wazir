 ...
 *
 * Formal catalog of 30 acceptance use cases structured into 10 progressive release gates (G0..G9).
 * Validates control-plane properties, routing, multi-model execution, isolation, governance, and resilience.
 *
 * Strict Release Rule:
...
export type AcceptanceGateId = 'G0' | 'G1' | 'G2' | 'G3' | 'G4' | 'G5' | 'G6' | 'G7' | 'G8' | 'G9';
