class Wazir < Formula
  ...
  url "https://github.com/whassan007/wazir/archive/refs/tags/v0.1.34.tar.gz"
  sha256 "9479a68ca66da9d15f48ea3cd1939ca03a9efb0eeaa7b349946bb49905ea030f"
  ...
  test do
    assert_match "0.1.34", shell_output("#{bin}/wa --version")
