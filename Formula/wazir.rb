class Wazir < Formula
  ...
  url "https://github.com/whassan007/wazir/archive/refs/tags/v0.1.26.tar.gz"
  sha256 "796344353ce3dc5ad13ec1ee0fe0095ce2178538fa843fb48f6bf127d9cdf6da"
  ...
  test do
    assert_match "0.1.26", shell_output("#{bin}/wa --version")
