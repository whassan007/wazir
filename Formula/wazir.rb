class Wazir < Formula
  ...
  url "https://github.com/whassan007/wazir/archive/refs/tags/v0.1.19.tar.gz"
  sha256 "6e0fac5a3b62e00a92901b117c69d16c03f7f1137ca4f5dc25b001e420d7d64c"
  ...
  test do
    assert_match "0.1.19", shell_output("#{bin}/wa --version")
