class Wazir < Formula
  ...
  url "https://github.com/whassan007/wazir/archive/refs/tags/v0.1.17.tar.gz"
  sha256 "cb69e4a71cc80221401822ed063003c45aab8d26844b95906f415317e9e98b30"
  ...
  test do
    assert_match "0.1.17", shell_output("#{bin}/wa --version")
